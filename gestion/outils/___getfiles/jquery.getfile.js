	...
	var GetFile = {
		...
		upload: function(fileList)
		{
			...
			$.ajax({
				...
				success: function(data)
				{
                    // throw event getfile:uploaded
                    that.element.trigger('getfile:uploaded', {
                        success: true,
                        data: data
                    });
					...
					{
                        that.element.one('getfile:throwcrop', function(event){
                        ...
                        // throw event getfile:throwcropwindow
                        that.element.trigger('getfile:throwcrop', {
                            success: true,
                            data: data
                        });
					}
					...
					{
                        that.element.one('getfile:throwresize', function(event){
                            if(!event.isDefaultPrevented())
                            {
                                if (that.options.multiple)
                                {
                        ...
                        // throw event getfile:throwresize
                        that.element.trigger('getfile:throwresize', {
                            success: true,
                            data: data
                        });
					}
