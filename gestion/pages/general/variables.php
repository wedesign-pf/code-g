<?php
$myTable=$thisSite->PREFIXE_TBL_GEN . "variables";
$orderby="id ASC";
$actionsPage=array("ajouter","supprimer");
$listCols=array();
$listCols[]=array("field"=>"id","label"=>"#","align"=>"center","width"=>"5%");
$listCols[]=array("field"=>"code","label"=>"Code","align"=>"left","width"=>"10%");
$listCols[]=array("field"=>"titre","label"=>"Titre","align"=>"left","width"=>"");
$listCols[]=array("field"=>"valeur","label"=>"Valeur","align"=>"left","width"=>"");
?>
<?php
